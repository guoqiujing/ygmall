			...
			<div style="width:58%;float:right;">
				...
				<div>
					...
					<div id="BtnArea" class="cartboxss">
						<button class="btn-buy-now" title="立即购买" type="button" onclick="alert('立即购买')">立即购买</button>
						<button id="btn-addCart" class="bnt-add-cart" type="button" onclick="alert('加入购物车')" title="加入购物车"><span>加入购物车</span></button>
