...
function addGoodsForm(){
    ...
    $("#"+newid+" .categoryId").val($("#goodsForm1 .categoryId").val());
    $("#"+newid+" .spuId").val($("#goodsForm1 .spuId").val());
    // var sd="#"+newid+" .labelInput label";
    // console.log("aa?");
    // $(sd).attr("for","labelInput");
    // console.log($(sd).html());
    // var df="#"+newid+" .labelInput input"
    // $(df).attr("id","labelInput");
}
// ①查询
...
var page = new Vue({
    ...
    methods: {
        ...
        getFile: function (event) {
            ...
            var index=event.target.id.substring(10);
